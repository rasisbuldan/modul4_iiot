...
async function changeValue(){
    ...
    document.getElementById("humidity_value").innerHTML = (60+(data.value1+1)*40).toFixed(2)
    document.getElementById("temperature_value").innerHTML = (20+(data.value2+1)*10).toFixed(2)
    document.getElementById("brightness_value").innerHTML = (700+(data.value3+1)*400).toFixed(2)
    document.getElementById("movingbar").style.width = 80*(data.value1+1)
